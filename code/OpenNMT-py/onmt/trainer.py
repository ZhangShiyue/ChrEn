    ...
    def train(self,
        ...
        for i, (batches, normalization) in enumerate(
            ...
            if valid_iter is not None and step % valid_steps == 0:
                ...
                if acc > best_acc and self.model_saver is not None:
                    best_acc = acc
                    logger.info('Best accuracy {} save best model..'.format(best_acc))
                    self.model_saver.save(0, moving_average=self.moving_average)
                if self.gpu_verbose_level > 0:
